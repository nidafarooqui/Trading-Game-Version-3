...
public class MainActivityLogin extends Activity {
 ...
 static Button registerr;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		forgetpass=(TextView)findViewById(R.id.textViewTurn);
		...
		login.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				{
					Toast.makeText(MainActivityLogin.this, "Congrats: Login Successful", Toast.LENGTH_LONG).show();
					Intent ii=new Intent(MainActivityLogin.this,WelcomeScreenActivity.class);
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				 ...
				 final Dialog dialog = new Dialog(MainActivityLogin.this);
		            ...
		            Button ok=(Button)dialog.findViewById(R.id.buttonContinue);
